...
//   const [cameras, setCameras] = useState([]);  // Empty initially
...
//   useEffect(() => {
//     // Fetch cameras from FastAPI backend
...
//             setCameras(data); // If data is a list of cameras, set state directly
//           } else {
//             setCameras(data.cameras || []); // Handle case where API returns {message: "", cameras: []}
//           }
//         } else {
...
//         {activeTab === "add-camera" && <AddCamera />}
